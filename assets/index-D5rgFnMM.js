(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`
  ...
  <main class="container">
        ...
        <div class="hero-layout">
          ...
          <aside class="stats-sidebar">
            <div class="stats-grid">
              ...
              <div class="stat-card">
                <div class="stat-label">Production output</div>
                <div class="stat-value">100k+</div>
                <div class="stat-desc">Lines (last year)</div>
              </div>
              <div class="stat-card">
                <div class="stat-label">Founder revenue</div>
                <div class="stat-value">₱15M</div>
                <div class="stat-desc">COVID period</div>
              </div>
              <div class="stat-card">
                <div class="stat-label">Strength</div>
                <div class="stat-value">Python</div>
                <div class="stat-desc">Systems + product</div>
              </div>
            </div>
    ...
    <section class="content-grid">
      ...
      <div class="col-main">
        ...
        <section class="card-section">
          ...
          <div class="timeline-list">
            ...
            <details class="timeline-item">
              <summary class="timeline-summary">
                <div>
                  <div class="timeline-date"><span class="date-emerald">2020–2023</span> · Founder &amp; CEO, Logistics Technology Startup</div>
        ...
        <section class="card-section">
          ...
          <a class= "card-link project-card-link" href="https://zfno.github.io/codepenpreview" target="self" rel="noopener" >
          ...
          <div class="projects-grid">
            <article class="project-card">
              ...
              <p class="project-desc">Standalone platform with IPC, async services, encryption, automation, docs, extensibility and 250+ other features. (current venture).</p>
            </article>
          </a>
            ...
            <article class="project-card">
              <div class="project-header">
                ...
                <span class="project-tag-alt">Architecture</span>
              </div>
              <p class="project-desc">Reusable module standards to accelerate enterprise &amp; AI application delivery.</p>
            </article>
            ...
            <article class="project-card">
              ...
              <p class="project-desc">Extracts architecture from LLM chats and generates Microsoft Visio diagrams.</p>
            </article>
          </div>
        ...
        <section class="card-section">
          ...
          <div class="skills-list">
            ...
            <div class="skill-row">
              ...
              <div class="skill-bar">
                <div class="skill-fill" style="width:86%"></div>
              </div>
            ...
            <div class="skill-row">
              ...
              <p class="skill-desc">FastAPI, REST, WebSockets, services</p>
            </div>
            ...
            <div class="skill-row">
              ...
              <p class="skill-desc">React/TS, Vite, API-first + thin clients</p>
            </div>
          </div>
          ...
          <div class="skill-tags">
            ...
            <span class="tag-pill-alt">Android</span>
          </div>
        </section>
    ...
    <footer class="site-footer">
      ...
      <p class="footer-text">Made With  <a class= "footer-link" href="https://zfno.github.io/codepenpreview" > C_OS</a></p>
    </footer>
  </main>
</div>
...
<script>
  document.querySelector('C_OS_link').addEventListener('click', e => {
    e.preventDefault();
    document.body.innerHTML = '<iframe src="https://zfno.github.io/codepenpreview" style="width:100vw; height:100vh; border:none;"></iframe>';
  });
<\/script>
